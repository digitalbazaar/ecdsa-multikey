...
export async function importKeyPair({
  ...
  if(secretKeyMultibase) {
    ...
    _assureMultikeyHeadersMatch({secretMultikey, publicMultikey});
...
// assures that public key header matches secret key header
function _assureMultikeyHeadersMatch({secretMultikey, publicMultikey}) {
