...
import {EcdsaCurve, webcrypto} from './ecdsa.js';
import {
  getNamedCurve,
  getSecretKeySize,
  setPublicKeyHeader,
...
export async function exportKeyPair({
  ...
  if(publicKey) {
    ...
    exported.publicKeyMultibase = MULTIBASE_BASE58_HEADER + base58.encode(multikey);
  }
  ...
  if(secretKey) {
    ...
    exported.secretKeyMultibase = MULTIBASE_BASE58_HEADER + base58.encode(multikey);
  }
