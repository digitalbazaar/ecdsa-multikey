...
export const ECDSA_2019_SECP_256K1_KEY_TYPE =
...
export const MULTICODEC_SECP256K1_PUBLIC_KEY_HEADER = new Uint8Array(
  [0xe7, 0x01]
);
...
export const MULTICODEC_SECP256K1_SECRET_KEY_HEADER = new Uint8Array(
  [0x81, 0x26]
);
