...
export const ECDSA_2019_SECP_256K1_KEY_TYPE = 'EcdsaSecp256k1VerificationKey2019';
...
// Multicodec secp256k1-pub header (0xe701)
// https://github.com/public-square/jwk-multibase-key-converter-php/blob/main/src/MultibaseConversionFactory.php#L17
export const MULTICODEC_SECP256K1_PUBLIC_KEY_HEADER = new Uint8Array([0xe7, 0x01]);
...
// Multicodec secp256k1-priv header (0x1301 varint -> 0x8126 hex)
// https://github.com/multiformats/multicodec/blob/master/table.csv
export const MULTICODEC_SECP256K1_SECRET_KEY_HEADER = new Uint8Array([0x81, 0x26]);
